...
<body>
	...
	<section style="padding-left: 130px; padding-top: 40px; padding-bottom: 80px;">
        <div class="tabs" style="width: 1250px;">
          ...
          <button class="tablinks" onclick="openTab('connection')" id="defaultOpen"><b>Add Connection</b></button>
        ...
        <div id="connectionTab" class="tabPanel" style="background-color: white; width: 1250px; padding-top: 30px;">
          <h4 style="padding-left: 10px;"><b>Add Connection -</b></h4>
        </div>

        <div id="consumersTab" class="tabPanel" style="background-color: white; width: 1250px; padding-top: 30px;">
            <h4 style="padding-left: 10px;"><b>Manage Consumer -</b></h4>
        </div>

        <div id="ordersTab" class="tabPanel" style="background-color: white; width: 1250px; padding-top: 30px;">
            <h4 style="padding-left: 10px;"><b>Check Orders -</b></h4>
        </div>
